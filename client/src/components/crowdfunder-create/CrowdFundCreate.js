...
export default CrowdFunderCreate => {
    ...
    const handleSubmit = (e) => {
        ...
        for(const key of Object.keys(cfForm)) {
            data.append(key, cfForm[key])
        }

        axios.post('/api/crowdfunder/create', data)
    ...
    <Container>
        ...
        <div className="crowdFundCreate">
            ...
            <input type="file" name="cf_image" className="form-control" placeholder="upload your image" 
            onChange={(e) => setcfForm({
            ...cfForm, [e.target.name]:e.target.files[0]
            }) } />
            <div class="img_preview_wrap">
            <img src="/uploads" width='200' height='200' />
            </div>
            ...
            <Button type='submit' variant='btn btn-warning'>Create a crowdfunder</Button>
